...
void main() {
  ...
  setUp(() {
    ...
    = MockHttpClient();
    dataSourcetv
    = HptvRemoteDataSourceImpl(client: mockHttpClient);
  });

  group('get Now Playing Tv', () {
    final tTvList
    = HptvResponse.fromJson(
    ...
    test('should return list of Tv Model when the response code is 200',
          ...
          // act
          final result
          = await dataSourcetv.getNowPlayingTv();
          // assert
    ...
    test(
        'should throw a ServerException when the response code is 404 or other',
          ...
          // act
          final call
          = dataSourcetv.getNowPlayingTv();
          // assert
          expect(()
          => call, throwsA(isA<ServerException>()));
        });
  });
  ...
  group('get Popular Tv', () {
    ...
    test('should return list of tv when response is success (200)',
          ...
          // act
          final result
          = await dataSourcetv.getPopularTv();
          // assert
  ...
  group('get Top Rated Tv', () {
    ...
    test('should return list of tv when response code is 200 ', () async {
      ...
      // act
      final result
      = await dataSourcetv.getTopRatedTv();
      // assert
      expect(result, tTvList);
    });
  ...
  group('get tv detail', () {
    ...
    test('should return movie detail when the response code is 200', () async {
      ...
      final
      result
      = await dataSourcetv.getTvDetail(tId);
      // assert
  ...
  group('get tv recommendations', () {
    ...
    test('should return list of Tv Model when the response code is 200',
          ...
          final
          result
          = await dataSourcetv.getTvRecommendations(tId);
          // assert
          expect(result, equals(tTvList));
        });
    ...
    test('should throw Server Exception when the response code is 404 or other',
          ...
          final
          call
          = dataSourcetv.getTvRecommendations(tId);
          // assert
          expect(()
          => call, throwsA(isA<ServerException>()));
        });
  ...
  group('search tv', () {
    ...
    test('should return list of tv when response code is 200', () async {
      ...
      final
      result
      = await dataSourcetv.searchTv(tQuery);
      // assert
